    ...
    <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-full lg:flex-none">
        <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl dark:bg-gray-950 border-black-125 rounded-2xl bg-clip-border">
            <div class="p-4 pb-0 mb-0 rounded-t-4">
                <h6 class="mb-2 dark:text-white">Daftar Penjual Menunggu Persetujuan</h6>
            </div>
            <div class="flex-auto p-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                                        <span class="text-xs font-semibold leading-tight dark:text-white/80 text-slate-400">{{ $user->created_at->format('d M Y') }}</span>
                                    </td>
                                    <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                ...
                @else
                    <div class="p-4 text-center border-dashed rounded-lg border-2 border-gray-200">
                        <p class="text-sm text-slate-500">Tidak ada penjual yang menunggu persetujuan saat ini.</p>
                    </div>
                @endif
            </div>
        </div>
